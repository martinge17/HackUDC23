...
const TYPE = "public";
const APP_ID = "c70a28ba";
const APP_KEY = "1645b8dcf8999ebeda077deefb00f502";
class Nutrient {
  String label;
  double value;
  ...
  @override
  String toString() {
    return "$label: ${value.roundToDouble()}\n";
  }
}
...
Future<RecipeBlock?> search_recipes(String query, String ingr, String cuisineType) async {
  // TODO: include a search criteria!
  var formattedQuery =
      "type=$TYPE&beta=true&app_id=$APP_ID&app_key=$APP_KEY&q=$query";
  if(ingr.isNotEmpty){
    formattedQuery += "&ingr=$ingr";
  }
  if(cuisineType.isNotEmpty){
    formattedQuery += "&cuisineType=$cuisineType";
  }
  var uri = Uri(
